...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AerolithProfile.avatarUrl'
        db.alter_column('accounts_aerolithprofile', 'avatarUrl', self.gf('django.db.models.fields.CharField')(max_length=512, null=True))


    def backwards(self, orm):
        
        # Changing field 'AerolithProfile.avatarUrl'
        db.alter_column('accounts_aerolithprofile', 'avatarUrl', self.gf('django.db.models.fields.TextField')(null=True))
