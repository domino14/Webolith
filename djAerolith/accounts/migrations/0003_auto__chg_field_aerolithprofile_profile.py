...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'AerolithProfile.profile'
        db.alter_column('accounts_aerolithprofile', 'profile', self.gf('django.db.models.fields.CharField')(max_length=2000))


    def backwards(self, orm):
        
        # Changing field 'AerolithProfile.profile'
        db.alter_column('accounts_aerolithprofile', 'profile', self.gf('django.db.models.fields.CharField')(max_length=1000))
