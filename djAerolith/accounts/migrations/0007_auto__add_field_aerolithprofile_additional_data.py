...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AerolithProfile.additional_data'
        db.add_column('accounts_aerolithprofile', 'additional_data', self.gf('django.db.models.fields.TextField')(default='{}'), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AerolithProfile.additional_data'
        db.delete_column('accounts_aerolithprofile', 'additional_data')
    ...
    models = {
        'accounts.aerolithprofile': {
            ...
            'avatarUrl': ('django.db.models.fields.CharField', [], {'max_length': '512', 'null': 'True', 'blank': 'True'}),
            ...
            'membershipExpiry': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'wordwallsMedals': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
