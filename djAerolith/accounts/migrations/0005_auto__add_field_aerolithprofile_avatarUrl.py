...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AerolithProfile.avatarUrl'
        db.add_column('accounts_aerolithprofile', 'avatarUrl', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AerolithProfile.avatarUrl'
        db.delete_column('accounts_aerolithprofile', 'avatarUrl')


    models = {
        'accounts.aerolithprofile': {
            'Meta': {'object_name': 'AerolithProfile'},
            'avatarUrl': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
