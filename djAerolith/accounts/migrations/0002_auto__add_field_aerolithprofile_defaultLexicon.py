...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AerolithProfile.defaultLexicon'
        db.add_column('accounts_aerolithprofile', 'defaultLexicon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Lexicon']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AerolithProfile.defaultLexicon'
        db.delete_column('accounts_aerolithprofile', 'defaultLexicon_id')
