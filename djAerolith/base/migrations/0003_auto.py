...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'Alphagram', fields ['alphagram']
        db.create_index('base_alphagram', ['alphagram'])


    def backwards(self, orm):
        
        # Removing index on 'Alphagram', fields ['alphagram']
        db.delete_index('base_alphagram', ['alphagram'])
