...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Word.inner_front_hook'
        db.add_column(u'base_word', 'inner_front_hook',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Word.inner_back_hook'
        db.add_column(u'base_word', 'inner_back_hook',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Word.inner_front_hook'
        db.delete_column(u'base_word', 'inner_front_hook')

        # Deleting field 'Word.inner_back_hook'
        db.delete_column(u'base_word', 'inner_back_hook')
    ...
    models = {
        ...
        u'base.alphagram': {
            ...
            'lexicon': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Lexicon']"}),
        ...
        u'base.word': {
            ...
            'alphagram': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Alphagram']"}),
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inner_back_hook': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'inner_front_hook': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'lexicon': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['base.Lexicon']"}),
