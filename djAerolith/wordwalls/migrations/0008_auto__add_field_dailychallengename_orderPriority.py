...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyChallengeName.orderPriority'
        db.add_column('wordwalls_dailychallengename', 'orderPriority', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailyChallengeName.orderPriority'
        db.delete_column('wordwalls_dailychallengename', 'orderPriority')
    ...
    models = {
        ...
        'base.alphagram': {
            ...
            'alphagram': ('django.db.models.fields.CharField', [], {'max_length': '15', 'db_index': 'True'}),
        ...
        'wordwalls.dailychallengeleaderboard': {
            ...
            'medalsAwarded': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        ...
        'wordwalls.dailychallengename': {
            'Meta': {'ordering': "['orderPriority', 'id']", 'object_name': 'DailyChallengeName'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'orderPriority': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
