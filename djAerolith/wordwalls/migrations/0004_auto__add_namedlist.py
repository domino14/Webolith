...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NamedList'
        db.create_table('wordwalls_namedlist', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('lexicon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['base.Lexicon'])),
            ('numQuestions', self.gf('django.db.models.fields.IntegerField')()),
            ('wordLength', self.gf('django.db.models.fields.IntegerField')()),
            ('isRange', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('wordwalls', ['NamedList'])


    def backwards(self, orm):
        
        # Deleting model 'NamedList'
        db.delete_table('wordwalls_namedlist')
