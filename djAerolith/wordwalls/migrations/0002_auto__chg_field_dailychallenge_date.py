...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DailyChallenge.date'
        db.alter_column('wordwalls_dailychallenge', 'date', self.gf('django.db.models.fields.DateField')())


    def backwards(self, orm):
        
        # Changing field 'DailyChallenge.date'
        db.alter_column('wordwalls_dailychallenge', 'date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
