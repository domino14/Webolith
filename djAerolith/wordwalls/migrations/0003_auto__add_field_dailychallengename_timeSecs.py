...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyChallengeName.timeSecs'
        db.add_column('wordwalls_dailychallengename', 'timeSecs', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailyChallengeName.timeSecs'
        db.delete_column('wordwalls_dailychallengename', 'timeSecs')
