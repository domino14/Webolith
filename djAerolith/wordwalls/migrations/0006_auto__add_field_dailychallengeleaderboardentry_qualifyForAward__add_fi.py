...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyChallengeLeaderboardEntry.qualifyForAward'
        db.add_column('wordwalls_dailychallengeleaderboardentry', 'qualifyForAward', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'DailyChallengeLeaderboardEntry.additionalData'
        db.add_column('wordwalls_dailychallengeleaderboardentry', 'additionalData', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailyChallengeLeaderboardEntry.qualifyForAward'
        db.delete_column('wordwalls_dailychallengeleaderboardentry', 'qualifyForAward')

        # Deleting field 'DailyChallengeLeaderboardEntry.additionalData'
        db.delete_column('wordwalls_dailychallengeleaderboardentry', 'additionalData')
    ...
    models = {
        ...
        'wordwalls.dailychallengeleaderboardentry': {
            ...
            'additionalData': ('django.db.models.fields.TextField', [], {'null': 'True'}),
            'board': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['wordwalls.DailyChallengeLeaderboard']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'qualifyForAward': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
        ...
        'wordwalls.wordwallsgamemodel': {
            ...
            'host': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'wordwalls_wordwallsgamemodel_host'", 'to': "orm['auth.User']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'inTable': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'wordwalls_wordwallsgamemodel_inTable'", 'symmetrical': 'False', 'to': "orm['auth.User']"}),
