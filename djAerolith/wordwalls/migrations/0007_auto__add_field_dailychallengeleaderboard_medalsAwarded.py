...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DailyChallengeLeaderboard.medalsAwarded'
        db.add_column('wordwalls_dailychallengeleaderboard', 'medalsAwarded', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DailyChallengeLeaderboard.medalsAwarded'
        db.delete_column('wordwalls_dailychallengeleaderboard', 'medalsAwarded')
