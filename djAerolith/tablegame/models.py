...
class Message(models.Model):
    # a message such as a chat, a word guess, pretty much any event that
    # happens in a table.
    user = models.ForeignKey(User)
    event = models.IntegerField(
        null=True, blank=True,
        choices=EVENT_CHOICES,
        help_text='An action performed in the room, either by a user or '
                  'by the system (e.g. XYZ leaves room.')
    text = models.TextField(
        null=True, blank=True,
        help_text='A message, either typed in by a user or generated by '
                  'the system.')
    unix_timestamp = models.FloatField(
        editable=False,
        help_text='Unix timestamp when this message was inserted into the '
                  'database.')
